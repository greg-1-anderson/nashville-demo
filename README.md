...
[![Travis CI](https://travis-ci.org/greg-1-anderson/nashville-demo.svg?branch=master)](https://travis-ci.org/greg-1-anderson/nashville-demo)
[![Windows CI](https://ci.appveyor.com/api/projects/status/hvo7vdhvhlpageu3?svg=true)](https://ci.appveyor.com/project/greg-1-anderson/nashville-demo)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/greg-1-anderson/nashville-demo/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/greg-1-anderson/nashville-demo/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/greg-1-anderson/nashville-demo/badge.svg?branch=master)](https://coveralls.io/github/greg-1-anderson/nashville-demo?branch=master) 
...
[![License](https://poser.pugx.org/greg-1-anderson/nashville-demo/license)](https://github.com/greg-1-anderson/nashville-demo//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/greg-1-anderson/nashville-demo)
| Linux permutation testing | [DONE](https://travis-ci.org/greg-1-anderson/nashville-demo)
| Windows testing           | [DONE](https://ci.appveyor.com/project/greg-1-anderson/nashville-demo)
| Static analysis           | [DONE](https://scrutinizer-ci.com/g/greg-1-anderson/nashville-demo/)
...
deploy:
  ...
  on:
    tags: true
    repo: greg-1-anderson/nashville-demo
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/greg-1-anderson/nashville-demo/tags). 

## Authors

* **Greg Anderson** - created project from template.

See also the list of [contributors](https://github.com/greg-1-anderson/nashville-demo/contributors) who participated in this project.
